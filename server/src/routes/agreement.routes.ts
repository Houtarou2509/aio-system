      ...
      const template = await agreementService.createTemplate(
        {
          ...
          secondarySignatoryTitle: req.body.secondarySignatoryTitle || undefined,
          firstSignatoryTitle: req.body.firstSignatoryTitle || undefined,
    ...
    try {
      ...
      const doc = await prisma.agreementDocument.findUnique({
        ...
        select: {
          ...
          secondarySignatoryTitle: true,
          firstSignatoryTitle: true,
          signatoryMode: true,
